...
/*   Updated: 2025/06/04 17:01:40 by porellan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void executor(t_backpack *backpack)
{
    ...
    else if(ft_strncmp(backpack->commands_lst[backpack->n].command, "export", 7)  == 0)
    {
        ft_export(backpack);
    }
    else if(ft_strncmp(backpack->commands_lst[backpack->n].command, "unset", 6)  == 0)
    {
        ft_unset(backpack);
    }
}
